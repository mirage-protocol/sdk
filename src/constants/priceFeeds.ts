...
import { ValidMoveCoins } from './types'

type CoinsWithPriceFeeds = ValidMoveCoins.APTOS | ValidMoveCoins.MIRAGE_APTOS | ValidMoveCoins.MIRAGE_ETHEREUM

export const PRICE_FEEDS: { readonly [coin in CoinsWithPriceFeeds]: string } = {
  [ValidMoveCoins.APTOS]:
  ...
  [ValidMoveCoins.MIRAGE_APTOS]:
    APTOS_NETWORK === 'mainnet'
      ? '0x03ae4db29ed4ae33d323568895aa00337e658e348b37509f5372ae51f0af00d5'
      : '0x44a93dddd8effa54ea51076c4e851b6cbbfd938e82eb90197de38fe8876bb66e',
  [ValidMoveCoins.MIRAGE_ETHEREUM]:
    APTOS_NETWORK === 'mainnet'
...
export function getPriceFeed(borrowCoin: ValidMoveCoins, collateralCoin: ValidMoveCoins): string {
  return PRICE_FEEDS[borrowCoin] || PRICE_FEEDS[collateralCoin]
}

export function getCollateralPriceFeed(collateralCoin: ValidMoveCoins) {
  return PRICE_FEEDS[collateralCoin]
}

export function getBorrowPriceFeed(borrowCoin: ValidMoveCoins) {
