...
import { getModuleAddress, MirageModules, PRECISION_8, ZERO } from '../../constants'
...
export class AirdropConfig {
  ...
  constructor(moduleResource: MoveResource[], network: Network) {
    const type = `${getModuleAddress(MirageModules.MirageScripts, network)}::distributor::AirdropConfig`
